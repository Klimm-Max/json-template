...
import io.github.matoklimm.functions.RandomTimestamp
...
class RandomTimestampTest {
    ...
    fun `non timestamp strings arg throws`() {
        ...
        assertFailsWith<IllegalArgumentException> {
            fn.execute(mutableListOf("2025-12-25"), ctx)
        }
    }
